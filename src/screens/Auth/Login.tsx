...
class LoginScreen extends React.Component {
  componentWillMount(){
    this.props.navigation.navigate("WalletsListScreen");
  };
  render() { 
    return (
      <View style={S.container}>
        ...
        <Block>
          ...
          <TouchableHighlight style={S.loginButton}   onPress={() => this.props.navigation.navigate('QRCodeScreen')} underlayColor={'transparent'}>
        ...
        <Block>
          <Text p>Don't have an account?  <Text onPress={() => this.props.navigation.navigate('RegisterScreen')} style={S.primaryTextColor} >Sign up</Text></Text>
        </Block>
