      ...
      <View style={S.container}>
        ...
        <Block>
          ...
          <TouchableHighlight style={S.loginButton} onPress={() => this.props.navigation.navigate('UploadScreen')} underlayColor={'transparent'}>
            <Text style={S.primaryTextColor} >Register</Text>
          </TouchableHighlight>
        </Block>
        <Block>
        ...
        <Block>
          <Text p>Already have an account? <Text onPress={() => this.props.navigation.navigate('LoginScreen')} style={S.primaryTextColor}>Log In</Text></Text>
        </Block>
